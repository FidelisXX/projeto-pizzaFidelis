...
export default function Order(){
    ...
    const [categorySelected, setCategorySelected] = useState<CategotyProps | undefined>()
    const [modalCategoryVisible, setModalCategotyVisible] = useState(false)
   ...
   async function handleCloseOrder(){
    ...
    function handleChangeCategory(item: CategotyProps){
    ...
    return(
        <View style={styles.container}>
            ...
            {category.length !==0 && (
                <TouchableOpacity style={styles.input} onPress={()=> setModalCategotyVisible(true)}>
          ...
          {products.length !== 0 && (
            ...
            >
                <ModalPicker
                    handleCloseModal={()=>setModalCategotyVisible(false)}
                    options={category}
